...
<div class="row">
	...
	<div class="col-sm-8">
	Servicios de Salud | Fundación | Enseñanza | Investigación | Contacto | English
	</div>
</div>
</div>
<div class="container">
 ...
 <h3 style="text-align: center;">Alta de Artículo</h3><br>
    ...
    <form role="form" id="rockjs" data-toggle="validator" class="shake">
        <div class="row">
			...
			<div class="form-group col-sm-6">
			<label for="entidad">Codigo de entidad contable</label>
		...
		<div class="row">
			<div class="form-group col-sm-6">
				<label for="reason-code">Codigo razon transferencia</label>
			...
			<div class="form-group col-sm-6">
				<label for="reference">Numero referencia</label>
				<input type="text" min="1" class="form-control" id="reference" placeholder="Enter reference" required data-error="reference is required">
				<div class="help-block with-errors"></div>
			</div>
		</div>
		<div class="row">
			<div class="form-group col-sm-6">
				<label for="reference2">Numero referencia transferencia</label>
				<input type="text" min="1" class="form-control" id="reference2" placeholder="Enter reference2" required data-error="reference2 is required">
				<div class="help-block with-errors"></div>
			</div>
			<div class="form-group col-sm-6">
		...
		<div class="row">
			<div class="form-group col-sm-6">
				<label for="line-no ">Numero de linea Backflush" </label>
			...
			<div class="form-group col-sm-6">
				...
				<input type="text" min="1" class="form-control" id="item-no" placeholder="Enter item-no" required data-error="item-no is required">
				<div class="help-block with-errors"></div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="form-group col-sm-6">
				...
				<input type="text" min="1" class="form-control" id="cost" placeholder="Enter cost" required data-error="cost is required">
				<div class="help-block with-errors"></div>
			</div>
			<div class="form-group col-sm-6">
