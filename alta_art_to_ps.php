<?php header('Access-Control-Allow-Origin: http://192.168.61.36'); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="container">
            <div style="padding-left: 5em; padding-right: 5em;padding-top: 0.5em;">
                ...
                <h3 style="text-align: center;">Alta de Artículo hacia PeopleSoft</h3><br>
            </div>
            <form role="form" id="rockjs" data-toggle="validator" class="shake">
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="tipo-mov">SETID</label>
                        <input type="text" value="MS010" class="form-control" id="SETID" placeholder="SETID" required data-error="SETID is required">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="entidad">INV_ITEM_ID</label>
                        <input type="text" value="422000155" class="form-control" id="INV_ITEM_ID" placeholder="Enter INV_ITEM_ID" required data-error="INV_ITEM_ID is required">	
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="row">
				    <div class="form-group col-sm-6">
                        <label for="reference">ITM_STATUS_EFFDT</label>
                        <input type="date" data-date-format="dd/mm/yy" min="1" class="form-control" id="ITM_STATUS_EFFDT" placeholder="Enter ITM_STATUS_EFFDT" required data-error="ITM_STATUS_EFFDT is required">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="reason-code">ITM_STATUS_CURRENT</label>
                        <input type="text" value="1" class="form-control" id="ITM_STATUS_CURRENT" placeholder="Enter ITM_STATUS_CURRENT " required data-error="ITM_STATUS_CURRENT  is required">
                        <div class="help-block with-errors"></div>
                    </div>	
                </div>
                <div class="row">
					<div class="form-group col-sm-6">
                        <label for="reference2">DESCR</label>
                        <input type="text" class="form-control" id="DESCR" placeholder="Enter DESCR" required data-error="DESCR is required">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="reference2">DESCRSHORT</label>
                        <input type="text" maxlength="8" class="form-control" id="DESCRSHORT" placeholder="Enter DESCRSHORT" required data-error="DESCRSHORT is required">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="row">
					<div class="form-group col-sm-6">
                        <label for="whs-code">DESCR60</label>
                        <input type="text" min="1" class="form-control" id="DESCR60" placeholder="Enter DESCR60" required data-error="DESCR60 is required">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="whs-zona ">UNIT_MEASURE_STD</label>
                        <input type="text" value="PZA" class="form-control" id="UNIT_MEASURE_STD" placeholder="Enter UNIT_MEASURE_STD" required data-error="UNIT_MEASURE_STD  is required">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="row">
					<div class="form-group col-sm-6">
                        <label for="vendor-code">CATEGORY_ID</label>
                        <input type="text" value="C0009" min="1" class="form-control" id="CATEGORY_ID" placeholder="Enter CATEGORY_ID" required data-error="CATEGORY_ID is required">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="line-no ">INVENTORY_ITEM</label>
                        <input type="text" value="true" class="form-control" id="INVENTORY_ITEM" placeholder="Enter INVENTORY_ITEM" required data-error="INVENTORY_ITEM  is required">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
				<div class="row">
					<div class="form-group col-sm-6">
                        <label for="vendor-code">FLAG</label>
                        <input type="text" value="true" class="form-control" id="FLAG" placeholder="Enter FLAG" required data-error="FLAG is required">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="row">
    ...
    <script type="text/javascript" src="js/alta_art_to_ps.js"></script>
</html>