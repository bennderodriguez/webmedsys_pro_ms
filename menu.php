                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="alta_art.php">Alta Artículo</a>
                            <a class="dropdown-item" href="consulta-art-json.php">Consulta de Artículo</a>
                            <a class="dropdown-item" href="surtir_pedido.php?p=pruebasur">Surtir Pedido</a>
							<a class="dropdown-item" href="alta_art_to_ps.php">Alta Artículo hacia PeopleSoft</a>
                        </div>
                    </li>
                </ul>
            </nav>
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/carrucel/1.jpg" alt="Medsys" width="1100" height="500">
                    </div>
                </div>
